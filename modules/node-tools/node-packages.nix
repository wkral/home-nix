...
let
  sources = {
    ...
    "@apidevtools/swagger-cli-4.0.2" = {
      ...
      version = "4.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@apidevtools/swagger-cli/-/swagger-cli-4.0.2.tgz";
        sha512 = "f2u+J7QlPySpMlB/jG522/8lKFXxeYt4ygd4FXZlidGrZsTE4Dbc5Hor4zO8vvM5QjrACvpN3zDnKIpb8QVR1g==";
      };
    };
    ...
    "@jsdevtools/ono-7.1.1" = {
      name = "_at_jsdevtools_slash_ono";
      packageName = "@jsdevtools/ono";
      version = "7.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@jsdevtools/ono/-/ono-7.1.1.tgz";
        sha512 = "pu5fxkbLQWzRbBgfFbZfHXz0KlYojOfVdUhcNfy9lef8ZhBt0pckGr8g7zv4vPX4Out5vBNvqd/az4UaVWzZ9A==";
      };
    };
...
in
{
  ajv-cli = nodeEnv.buildNodePackage {
    ...
    version = "3.1.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/ajv-cli/-/ajv-cli-3.1.0.tgz";
      sha512 = "QSHstRjJin970EspY92Qr8lDGYE9C88AwW7LJYJ/MFhKDsE6I75H2b8WObCeF+2q/1fJiolm0xX7I/VyGmw/JQ==";
    };
    dependencies = [
  ...
  swagger-cli = nodeEnv.buildNodePackage {
    ...
    version = "4.0.2";
    src = fetchurl {
      url = "https://registry.npmjs.org/swagger-cli/-/swagger-cli-4.0.2.tgz";
      sha512 = "XzKVHMDGlmiK+dgTxRSX7SSbG5KDsU4RS9eX3VSBw6ZPfW1aWYAbo2FuhArnsFMiz4/0KXJ8D/Lkii7xeSXviw==";
    };
    dependencies = [
      sources."@apidevtools/json-schema-ref-parser-8.0.0"
      sources."@apidevtools/openapi-schemas-2.0.3"
      sources."@apidevtools/swagger-cli-4.0.2"
      sources."@apidevtools/swagger-methods-3.0.1"
      sources."@apidevtools/swagger-parser-9.0.1"
      sources."@jsdevtools/ono-7.1.1"
